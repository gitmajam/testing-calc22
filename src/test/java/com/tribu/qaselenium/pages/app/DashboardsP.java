...
public class DashboardsP extends BasePO<DashboardsP> {
	...
	public DashboardsP getSearchButton(Predicate<WebElement>... predicates) {
		this.setWebElement(searchButton, predicates);
		return this;
	}

	public DashboardsP getModalUpload(Predicate<WebElement>... predicates) {
		this.setWebElement(modalUpload, predicates);
		return this;
	}

	public DashboardsP getModalRespUpload(Predicate<WebElement>... predicates) {
		this.setWebElement(modalRespUpload, predicates);
		return this;
	}

	public DashboardsP getButton(Predicate<WebElement>... predicates) {
		this.setWebElement(button, predicates);
		return this;
	}

	public DashboardsP getAppBusy(Predicate<WebElement>... predicates) {
		this.setWebElement(appBusy, predicates);
		return this;
	}

	public DashboardsP getGraphics(Predicate<WebElement>... predicates) {
		this.setWebElement(graphics, predicates);
		return this;
	}

	public DashboardsP getInputSearch(Predicate<WebElement>... predicates) {
		this.setWebElement(inputSearch, predicates);
		return this;
	}

	public DashboardsP getFilter(Predicate<WebElement>... predicates) {
		this.setWebElement(filter, predicates);
		return this;
	}

	public DashboardsP getSelect(Predicate<WebElement>... predicates) {
		this.setWebElement(select, predicates);
		return this;
	}

	public DashboardsP getItem(Predicate<WebElement>... predicates) {
		this.setWebElement(item, predicates);
		return this;
	}

	public DashboardsP getTotalInitiatives(Predicate<WebElement>... predicates) {
		this.setWebElement(totalInitiatives, predicates);
		return this;
	}

	public DashboardsP getRegisterInitiatives(Predicate<WebElement>... predicates) {
		this.setWebElement(registerInitiatives, predicates);
		return this;
	}

	public DashboardsP getSuccesUploadMessage(Predicate<WebElement>... predicates) {
		this.setWebElement(succesUploadMessage, predicates);
		return this;
	}

	public DashboardsP getCloseButton(Predicate<WebElement>... predicates) {
		this.setWebElement(closeButton, predicates);
		return this;
	}

	public DashboardsP getUpdateDashboardButton(Predicate<WebElement>... predicates) {
		this.setWebElement(updateDashboardButton, predicates);
		return this;
	}

	public DashboardsP getInputLoadFile(Predicate<WebElement>... predicates) {
		this.setWebElement(inputLoadFile, predicates);
		return this;
	}

	public DashboardsP getPeriodSelect(Predicate<WebElement>... predicates) {
		this.setWebElement(periodSelect, predicates);
		return this;
	}

	public DashboardsP getPeriod(Predicate<WebElement>... predicates) {
		this.setWebElement(period, predicates);
		return this;
	}

	public DashboardsP getSaveUploadButton(Predicate<WebElement>... predicates) {
		this.setWebElement(saveUploadButton, predicates);
		return this;
	}

	public DashboardsP getCancelUploadButton(Predicate<WebElement>... predicates) {
		this.setWebElement(cancelUploadButton, predicates);
		return this;
	}

	public DashboardsP getSummaryTable(Predicate<WebElement>... predicates) {
		this.setWebElement(summaryTable, predicates);
		return this;
	}

	public DashboardsP verifyTargets(List<Map<String, String>> provider, List<Map<String, String>> table) {
	...
	public DashboardsP verifyAmounts(List<Map<String, String>> provider, List<Map<String, String>> table,String amount) {
	...
	public DashboardsP verifyLoadFinish() {
	...
	public DashboardsP verifyFilters(String filterL1, List<Map<String, String>> filters) {
	...
	@SuppressWarnings("unchecked")
	public DashboardsP verifyCombinedFilters(List<Map<String, String>> provider) {

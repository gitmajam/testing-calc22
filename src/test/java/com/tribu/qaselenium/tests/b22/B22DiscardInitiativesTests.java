...
public class B22DiscardInitiativesTests extends TestBase {
	...
	public static String dataProviderFilePath = "src/test/resources/providerFiles/amountsDiscards.csv";

	@SuppressWarnings("unchecked")
	@Test(dataProvider = "csvReaderMatrix", dataProviderClass = CsvDataProviders.class,groups = { "smoke", "deleteContent" })
	public void discardInitiatives(Method method, List<Map<String, String>> provider) {
		// page variables
		...
		String pathName = System.getProperty("user.dir") + File.separator + "src" + File.separator + "test"
				+ File.separator + "resources" + File.separator + "uploadFiles"	+ File.separator + "discardTemplate2.xlsx";

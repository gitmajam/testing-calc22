...
public class EmailableTestingReporter implements IReporter {
	private static final Logger LOG = Logger.getLogger(EmailableTestingReporter.class);
	...
	private String fileName = "emailable-testing-report.html";
			...
			for (ClassResult classResult : classResults) {
				...
				for (MethodResult methodResult : classResult.getMethodResults()) {
					...
					buffer.append("<td><a href=\"#m").append(scenarioIndex).append("\">").append(methodName)
							...
							.append(getFormattedStartTime(start)).append("</td>").append("<td rowspan=\"")
							.append(resultsCount).append("\">").append(duration).append("</td></tr>");
					scenarioIndex++;
